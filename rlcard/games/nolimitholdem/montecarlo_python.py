...
from rlcard.games.nolimitholdem.hand_evaluator import eval_best_hand
...
class MonteCarlo(object):
    ...
    def run_montecarlo(self, original_player_card_list, original_table_card_list, player_amount, ui, maxRuns,
        ...
        for m in range(maxRuns):
            ...
            # all_cards = []
            # for hand in PlayerFinalCardsWithTableCards:
            #     all_cards.append([card[::-1] for card in hand])
            #
            # bestHand, winnerCardType = compare_hands(all_cards)
